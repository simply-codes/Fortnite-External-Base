...
void ImGui::RenderFrameBorder(ImVec2 p_min, ImVec2 p_max, float rounding)
{
    ...
    GetWindowDrawList()->AddRect(p_min + ImVec2(1, 1), p_max + ImVec2(1, 1), GetColorU32(ImGuiCol_BorderShadow), 0, ImDrawCornerFlags_All, border_size);
    GetWindowDrawList()->AddRect(p_min, p_max, GetColorU32(ImGuiCol_Border), 0, ImDrawCornerFlags_All, border_size);
...
static void AddDrawListToDrawData(ImVector<ImDrawList*>* out_list, ImDrawList* draw_list)
{
    ...
    //       Some 
    // hics API such as GL ES 1/2 don't have a way to offset the starting vertex so it is not supported for them.
